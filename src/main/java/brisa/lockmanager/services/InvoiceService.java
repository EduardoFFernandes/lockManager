...
public class InvoiceService implements Routes {
    ...
    public static Invoice populateInvoice(Purchase object) {
        ...
        InvoiceItem item = new InvoiceItem("Item 1" ,"descricao do item 1", new BigDecimal("300"), 3);
//        ArrayList<InvoiceItem> itens = InvoiceService.getItens(object.getLstPurchaseItem());
        ArrayList<InvoiceItem> itens = new ArrayList<InvoiceItem>();
        itens.add(item);
        ...
        String date = object.getPurchaseDate().toString();
        ...
        Invoice invoice = new Invoice(itens, companyName, address, postal, destinataryName, destinataryAdress, destinataryPostal, termsAndConditions, date, dueDate, discount, taxRate, image);
